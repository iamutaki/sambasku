...
mixin _$WordSummaryDto {
 ...
 String get id; String get lemma;@JsonKey(name: 'language_id') String get languageId;@JsonKey(name: 'language_code') String get languageCode;@JsonKey(name: 'word_type') String get wordType;@JsonKey(name: 'is_verified') bool get isVerified;@JsonKey(name: 'matched_translation') String? get matchedTranslation;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,lemma,languageId,languageCode,wordType,isVerified,matchedTranslation);

@override
String toString() {
  return 'WordSummaryDto(id: $id, lemma: $lemma, languageId: $languageId, languageCode: $languageCode, wordType: $wordType, isVerified: $isVerified, matchedTranslation: $matchedTranslation)';
}
...
@useResult
$Res call({
 String id, String lemma,@JsonKey(name: 'language_id') String languageId,@JsonKey(name: 'language_code') String languageCode,@JsonKey(name: 'word_type') String wordType,@JsonKey(name: 'is_verified') bool isVerified,@JsonKey(name: 'matched_translation') String? matchedTranslation
});
...
/// Create a copy of WordSummaryDto
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? lemma = null,Object? languageId = null,Object? languageCode = null,Object? wordType = null,Object? isVerified = null,Object? matchedTranslation = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String lemma, @JsonKey(name: 'language_id')  String languageId, @JsonKey(name: 'language_code')  String languageCode, @JsonKey(name: 'word_type')  String wordType, @JsonKey(name: 'is_verified')  bool isVerified, @JsonKey(name: 'matched_translation')  String? matchedTranslation)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _WordSummaryDto() when $default != null:
return $default(_that.id,_that.lemma,_that.languageId,_that.languageCode,_that.wordType,_that.isVerified,_that.matchedTranslation);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String lemma, @JsonKey(name: 'language_id')  String languageId, @JsonKey(name: 'language_code')  String languageCode, @JsonKey(name: 'word_type')  String wordType, @JsonKey(name: 'is_verified')  bool isVerified, @JsonKey(name: 'matched_translation')  String? matchedTranslation)  $default,) {final _that = this;
switch (_that) {
case _WordSummaryDto():
return $default(_that.id,_that.lemma,_that.languageId,_that.languageCode,_that.wordType,_that.isVerified,_that.matchedTranslation);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String lemma, @JsonKey(name: 'language_id')  String languageId, @JsonKey(name: 'language_code')  String languageCode, @JsonKey(name: 'word_type')  String wordType, @JsonKey(name: 'is_verified')  bool isVerified, @JsonKey(name: 'matched_translation')  String? matchedTranslation)?  $default,) {final _that = this;
switch (_that) {
case _WordSummaryDto() when $default != null:
return $default(_that.id,_that.lemma,_that.languageId,_that.languageCode,_that.wordType,_that.isVerified,_that.matchedTranslation);case _:
  return null;
...
class _WordSummaryDto implements WordSummaryDto {
  const _WordSummaryDto({required this.id, required this.lemma, @JsonKey(name: 'language_id') required this.languageId, @JsonKey(name: 'language_code') required this.languageCode, @JsonKey(name: 'word_type') required this.wordType, @JsonKey(name: 'is_verified') required this.isVerified, @JsonKey(name: 'matched_translation') this.matchedTranslation});
...
/// Create a copy of WordSummaryDto
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? lemma = null,Object? languageId = null,Object? languageCode = null,Object? wordType = null,Object? isVerified = null,Object? matchedTranslation = freezed,}) {
