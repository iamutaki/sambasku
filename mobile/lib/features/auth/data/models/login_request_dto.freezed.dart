...
mixin _$LoginRequestDto {
 ...
 String get email; String get password; String get clientType;
...
@useResult
$Res call({
 String email, String password, String clientType
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String email,  String password,  String clientType)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LoginRequestDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String email,  String password,  String clientType)  $default,) {final _that = this;
switch (_that) {
case _LoginRequestDto():
return $default(_that.email,_that.password,_that.clientType);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String email,  String password,  String clientType)?  $default,) {final _that = this;
switch (_that) {
case _LoginRequestDto() when $default != null:
return $default(_that.email,_that.password,_that.clientType);case _:
  return null;
...
class _LoginRequestDto implements LoginRequestDto {
  const _LoginRequestDto({required this.email, required this.password, this.clientType = 'mobile'});
  factory _LoginRequestDto.fromJson(Map<String, dynamic> json) => _$LoginRequestDtoFromJson(json);

@override final  String email;
@override final  String password;
@override@JsonKey() final  String clientType;
...
mixin _$RefreshRequestDto {
 ...
 String get refreshToken; String get clientType;
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String refreshToken,  String clientType)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RefreshRequestDto() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String refreshToken,  String clientType)  $default,) {final _that = this;
switch (_that) {
case _RefreshRequestDto():
return $default(_that.refreshToken,_that.clientType);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String refreshToken,  String clientType)?  $default,) {final _that = this;
switch (_that) {
case _RefreshRequestDto() when $default != null:
return $default(_that.refreshToken,_that.clientType);case _:
  return null;
...
class _RefreshRequestDto implements RefreshRequestDto {
  const _RefreshRequestDto({required this.refreshToken, this.clientType = 'mobile'});
